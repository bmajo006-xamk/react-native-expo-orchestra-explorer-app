    ...
    <View style={styles.container}>
        ...
        <ScrollView style={[styles.scrollView,{height:windowHeight}]}>
            <View style={styles.titleView}>
                <Text style={styles.title}>Poikkihuilu</Text>
            </View>
            <Animated.View>
                <Image  source={require('../../imgs/poikkihuilu.jpg')} style={[styles.img]} />
            </Animated.View>
            <View style={styles.row_1}>
                ...
                <Text style={styles.textView}>Poikkihuilu on puupuhaltimiin kuuluva soitin, jota yleensä tarkoitetaan, kun puhutaan huilusta. Korkealla soiva huilu kuljettaa orkesterissa usein melodiaa. </Text>
            </View>
        </ScrollView>
    </View>
);
