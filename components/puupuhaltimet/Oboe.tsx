    ...
    <View style={styles.container}>
        <ScrollView style={[styles.scrollView,{height:windowHeight}]}>
            <View style={[styles.titleView, {top: 10}]}>
                <Text style={styles.title}>Oboe</Text>
            </View>
            <Animated.View>
                <Image  source={require('../../imgs/oboe.jpg')} style={[styles.img]} />
            </Animated.View>
            <View style={styles.row_1}>
                ...
                <Text style={styles.textView}>Oboe on puupuhallin, jolla on orkesterissa usein solistisia tehtäviä. Oboen ääni on diskanttipainotteinen (ääniala noin b-G3), selkeä ja se kuuluu hyvin suurenkin orkesterin läpi. Oboe antaa myös orkesterille viritysäänen juuri ennen konsertin alkua.</Text>
            </View>
        </ScrollView>
    </View>
);
