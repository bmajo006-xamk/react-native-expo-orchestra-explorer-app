    ...
    <View style={styles.container}>
        ...
        <ScrollView style={[styles.scrollView,{height:windowHeight}]}>
            <View style={styles.titleView}>
                <Text style={styles.title}>Klarinetti</Text>
            </View>
            <Animated.View>
                <Image  source={require('../../imgs/klarinetti.jpg')} style={[styles.img]} />
            </Animated.View>
            <View style={styles.row_1}>
                ...
                <Text style={styles.textView}>Klarinetti on notkea soitin, joka sopii kaikentyyppiseen musiikkiin. Puupuhallin klarinetti on myös nykysäveltäjien suosiossa.</Text>
            </View>
        </ScrollView>
    </View>
);
