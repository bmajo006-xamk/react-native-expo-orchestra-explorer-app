...
const Alttoviulu = () => {
    ...
    <View style={styles.container}>
        ...
        <View style={styles.titleView}>
                <Text style={styles.title}>Alttoviulu</Text>
            </View>
            <Animated.View>
                <Image  source={require('../../imgs/alttoviulu.jpg')} style={[styles.img]} />
            </Animated.View>
            <View style={styles.row_1}>
                ...
                <Text style={styles.textView}>Alttoviulussa on matalampi sointi kuin viulussa. Se on myös kooltaan hiukan viulua isompi. Alttoviulussa on neljä kieltä, jotka viritetään kvintin välein:  {'\n'}c, g, d1, a1</Text>
            </View>
        </ScrollView>
    </View>
);
