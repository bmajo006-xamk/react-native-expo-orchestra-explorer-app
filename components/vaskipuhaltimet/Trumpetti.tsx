    ...
    <View style={styles.container}>
        ...
        <ScrollView style={[styles.scrollView,{height:windowHeight}]}>
            <View style={styles.titleView}>
                <Text style={styles.title}>Trumpetti</Text>
            </View>
            <Animated.View>
                <Image  source={require('../../imgs/trumpetti.jpg')} style={[styles.img]} />
            </Animated.View>
            <View style={styles.row_1}>
                ...
                <Text style={styles.textView}>Trumpetti on vaskisoitinperheen korkein soitin. Ääni tuotetaan trumpetissa samalla tavalla kuin kaikissa vaskisoittimissa: soittaja painaa suukappaleen huuliaan vasten ja puhaltaa. Yleisin trumpetti on B-vireinen.</Text>
            </View>
        </ScrollView>
    </View>
);
