    ...
    <View style={styles.container}>
        ...
        <ScrollView style={[styles.scrollView,{height:windowHeight}]}>
            <View style={styles.titleView}>
                <Text style={styles.title}>Tuuba</Text>
            </View>
            <Animated.View>
                <Image  source={require('../../imgs/tuuba.jpg')} style={[styles.img]} />
            </Animated.View>
            <View style={styles.row_1}>
                ...
                <Text style={styles.textView}>Tuuba on vaskipuhallinperheen matalaäänisin jäsen. Sen ääniala on noin C2–f1. Tuubia valmistetaan pääosin B-, C-, Es-, ja F-vireisinä.</Text>
            </View>
        </ScrollView>
    </View>
);
